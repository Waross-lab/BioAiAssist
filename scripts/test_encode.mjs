#!/usr/bin/env node
// scripts/test_encode.mjs  — robust ENCODE Experiment query helper (ESM)
// Usage examples:
//   node scripts/test_encode.mjs "ChIP-seq in Homo sapiens GM12878"
//   node scripts/test_encode.mjs "RNA-seq in Mus musculus brain"
...
(async () => {
  try {
    ...
    if (!q) {
      console.error('Usage: node scripts/test_encode.mjs "<assay> in <organism> <biosample?>"');
      process.exit(64);
    }
